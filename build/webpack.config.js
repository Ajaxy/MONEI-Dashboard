...
if (__DEV__) {
  ...
  debug('Enable plugins for production (AggressiveMerging, OccurenceOrder, Dedupe & UglifyJS).');
  webpackConfig.plugins.push(
...
// AWS configuration
// ------------------------------------
process.env.AWS_SERVICES = config.aws_services.join(',');
webpackConfig.module.loaders.push({
  test: /node_modules[\\\/]aws-sdk/,
  loaders: [
    'transform-loader?aws-sdk/dist-tools/transform'
  ]
});
