      ...
      <div className="column">
        ...
        <form className="shopify-form">
          ...
          <div className="shopify-form__row">
            ...
            <input type="text" value={channel.sender} readOnly onClick={() => copy(channel.sender, 'Sender ID')} />
          </div>
          <div className="shopify-form__row">
            <label>Channel ID</label>
            <input type="text" value={channel.channel} readOnly onClick={() => copy(channel.channel, 'Channel ID')} />
          </div>
          <div className="shopify-form__row">
            <label>Login</label>
            <input type="text" value={channel.login} readOnly onClick={() => copy(channel.login, 'Login')} />
          </div>
          <div className="shopify-form__row">
            <label>Password</label>
            <input type="text" value={channel.pwd} readOnly onClick={() => copy(channel.pwd, 'Password')} />
          </div>
